...
export class Feedback {
   ...
   *
   * @throws {@link LangfuseAPI.FeedbackNotConfiguredError}
   ...
   */
  public submit(
    request: LangfuseAPI.SubmitFeedbackRequest,
    requestOptions?: Feedback.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.SubmitFeedbackResponse> {
    return core.HttpResponsePromise.fromPromise(
      this.__submit(request, requestOptions),
    );
  }
  ...
  private async __submit(
    request: LangfuseAPI.SubmitFeedbackRequest,
    requestOptions?: Feedback.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.SubmitFeedbackResponse>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.SubmitFeedbackResponse,
    ...
    if (_response.error.reason === "status-code") {
      switch (_response.error.statusCode) {
        case 409:
          throw new LangfuseAPI.FeedbackNotConfiguredError(
    ...
    switch (_response.error.reason) {
      ...
      case "timeout":
        throw new errors.LangfuseAPITimeoutError(
          "Timeout exceeded when calling POST /api/public/feedback.",
        );
      case "unknown":
        throw new errors.LangfuseAPIError({
