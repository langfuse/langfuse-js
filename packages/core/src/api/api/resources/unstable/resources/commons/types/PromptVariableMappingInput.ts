...
/**
 * Connects one prompt variable to the available evaluation data.
 *
 ...
 * - `missing_variable_mapping`: one or more LLM-as-judge prompt variables are not mapped yet
 * - `duplicate_variable_mapping`: the same prompt variable appears more than once
 ...
 *         source: LangfuseAPI.unstable.PromptVariableMappingSource.Metadata,
 ...
 *         source: LangfuseAPI.unstable.PromptVariableMappingSource.ExpectedOutput
 *     }
 */
export interface PromptVariableMappingInput {
   ...
   */
  source: LangfuseAPI.unstable.PromptVariableMappingSource;
  /**
