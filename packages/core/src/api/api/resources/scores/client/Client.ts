...
export class Scores {
   ...
   *
   * **SDK namespace mapping:** In SDKs, `client.scores` always points to the latest supported scores API. Legacy V1 create/delete endpoints remain available under `client.legacy.scoreV1`.
   *
