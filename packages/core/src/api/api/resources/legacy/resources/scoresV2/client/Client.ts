...
export declare namespace ScoresV2 {
...
export class ScoresV2 {
  protected readonly _options: ScoresV2.Options;

  constructor(_options: ScoresV2.Options) {
   ...
   *
   * @param {LangfuseAPI.legacy.GetScoresRequest} request
   * @param {ScoresV2.RequestOptions} requestOptions - Request-specific configuration.
   *
   ...
   *
   * @example
   *     await client.legacy.scoresV2.getMany()
   */
  public getMany(
    request: LangfuseAPI.legacy.GetScoresRequest = {},
    requestOptions?: ScoresV2.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.GetScoresResponse> {
  ...
  private async __getMany(
    request: LangfuseAPI.legacy.GetScoresRequest = {},
    requestOptions?: ScoresV2.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.GetScoresResponse>> {
    const {
      page,
      limit,
      userId,
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.GetScoresResponse,
   ...
   *
   * @example
   *     await client.legacy.scoresV2.getById("scoreId")
   */
  public getById(
    scoreId: string,
    requestOptions?: ScoresV2.RequestOptions,
