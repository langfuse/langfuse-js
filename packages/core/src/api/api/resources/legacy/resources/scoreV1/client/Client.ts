...
export declare namespace ScoreV1 {
...
export class ScoreV1 {
   ...
   *
   * @param {LangfuseAPI.legacy.CreateScoreV1Request} request
   ...
   */
  public create(
    request: LangfuseAPI.legacy.CreateScoreV1Request,
    requestOptions?: ScoreV1.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.CreateScoreV1Response> {
  ...
  private async __create(
    request: LangfuseAPI.legacy.CreateScoreV1Request,
    requestOptions?: ScoreV1.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.CreateScoreV1Response>> {
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.CreateScoreV1Response,
