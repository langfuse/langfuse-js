...
export class MetricsV1 {
   ...
   */
  public metrics(
    request: LangfuseAPI.legacy.GetMetricsRequest,
    requestOptions?: MetricsV1.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.MetricsResponse> {
  ...
  private async __metrics(
    request: LangfuseAPI.legacy.GetMetricsRequest,
    requestOptions?: MetricsV1.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.MetricsResponse>> {
    const { query } = request;
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.MetricsResponse,
