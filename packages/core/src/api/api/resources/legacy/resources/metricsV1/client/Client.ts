...
export declare namespace MetricsV1 {
...
export class MetricsV1 {
  ...
  /**
   * Get metrics from the Langfuse project using a query object (Metrics V1, deprecated).
   *
   * **Deprecated:** Use `/api/public/v2/metrics` for better performance.
   *
   * **SDK namespace mapping:** In SDKs, this endpoint is available under `client.legacy.metricsV1`. The default `client.metrics` namespace always points to the latest supported metrics API.
   *
   * For more details, see the [Metrics API documentation](https://langfuse.com/docs/metrics/features/metrics-api).
   *
   * @param {LangfuseAPI.legacy.GetMetricsV1Request} request
   ...
   */
  public metrics(
    request: LangfuseAPI.legacy.GetMetricsV1Request,
    requestOptions?: MetricsV1.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.MetricsV1Response> {
  ...
  private async __metrics(
    request: LangfuseAPI.legacy.GetMetricsV1Request,
    requestOptions?: MetricsV1.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.MetricsV1Response>> {
    const { query } = request;
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.MetricsV1Response,
