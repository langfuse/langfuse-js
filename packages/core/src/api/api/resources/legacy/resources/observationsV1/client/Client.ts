...
export declare namespace ObservationsV1 {
...
export class ObservationsV1 {
   ...
   * **SDK namespace mapping:** In SDKs, this endpoint is available under `client.legacy.observationsV1`. The default `client.observations` namespace always points to the latest supported observations API.
   *
   * @param {LangfuseAPI.legacy.GetObservationsV1Request} request
   * @param {ObservationsV1.RequestOptions} requestOptions - Request-specific configuration.
   *
   * @throws {@link LangfuseAPI.Error}
   * @throws {@link LangfuseAPI.UnauthorizedError}
   ...
   */
  public getMany(
    request: LangfuseAPI.legacy.GetObservationsV1Request = {},
    requestOptions?: ObservationsV1.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.ObservationsV1Views> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __getMany(
    request: LangfuseAPI.legacy.GetObservationsV1Request = {},
    requestOptions?: ObservationsV1.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.ObservationsV1Views>> {
    const {
      page,
      limit,
      name,
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.ObservationsV1Views,
        rawResponse: _response.rawResponse,
      };
    }
