...
export class ObservationsV1 {
   ...
   */
  public getMany(
    request: LangfuseAPI.legacy.GetObservationsRequest = {},
    requestOptions?: ObservationsV1.RequestOptions,
  ): core.HttpResponsePromise<LangfuseAPI.legacy.ObservationsViews> {
    return core.HttpResponsePromise.fromPromise(
  ...
  private async __getMany(
    request: LangfuseAPI.legacy.GetObservationsRequest = {},
    requestOptions?: ObservationsV1.RequestOptions,
  ): Promise<core.WithRawResponse<LangfuseAPI.legacy.ObservationsViews>> {
    const {
      page,
      limit,
      name,
    ...
    if (_response.ok) {
      return {
        data: _response.body as LangfuseAPI.legacy.ObservationsViews,
        rawResponse: _response.rawResponse,
      };
    }
