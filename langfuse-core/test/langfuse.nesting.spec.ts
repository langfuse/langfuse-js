...
import { LangfuseObjectClient } from '../src'
    ...
    it('should create a trace', async () => {
      ...
      const checks = [
        ...
        },
        {
          ...
          object: { name: 'test-event-1', traceId: trace.id, parentObservationId: span2.id },
        },
        {
          url: 'https://cloud.langfuse.com/api/public/scores',
          object: { name: 'test-score-1', traceId: trace.id, observationId: event.id, value: 0.5 },
        },
      ]
