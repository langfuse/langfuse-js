...
import { assert, generateUUID, removeTrailingSlash, retriable, RetriableOptions, safeSetTimeout } from './utils'
...
export abstract class LangfuseObjectClient {
  ...
  event(body: Omit<CreateLangfuseEventBody, 'traceId' | 'parentObservationId'>): LangfuseEventClient {
    return this.client.event({ ...body, traceId: this.traceId, parentObservationId: this.observationId })
  }

  span(body: Omit<CreateLangfuseSpanBody, 'traceId' | 'parentObservationId'>): LangfuseSpanClient {
    return this.client.span({ ...body, traceId: this.traceId, parentObservationId: this.observationId })
  }

  generation(body: Omit<CreateLangfuseGenerationBody, 'traceId' | 'parentObservationId'>): LangfuseGenerationClient {
    return this.client.generation({ ...body, traceId: this.traceId, parentObservationId: this.observationId })
  }

  score(body: Omit<CreateLangfuseScoreBody, 'traceId' | 'parentObservationId'>): this {
    this.client.score({ ...body, traceId: this.traceId, observationId: this.observationId })
    return this
  }
}
